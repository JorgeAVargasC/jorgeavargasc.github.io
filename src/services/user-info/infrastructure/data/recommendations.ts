import type { IRecommendation } from '../../domain/interfaces/recommendation.interface'
...
export const recommendations: IRecommendation[] = [
	...
	},
	{
		...
		body: [
			...
			'During our collaboration, I saw firsthand how Jorge’s technical expertise is complemented by his collaborative/organized nature and problem-solving mindset. He is someone who thrives under challenges, constantly pushing the boundaries to deliver outstanding results. His ability to balance creativity with precision is remarkable and sets him apart as a true professional in his field. ',
